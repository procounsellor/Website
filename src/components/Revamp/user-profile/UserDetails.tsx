const data = [
    {title:'Mobile Number', value:'+91 1234567890'},
    {title:'Email', value:'abc@gmail.com'},
    {title:'Current City', value:'New Delhi'}
]
...
export default function UserDetails() {
  return (
    <div className="relative flex flex-col gap-6 bg-white w-62 h-153.75 p-6 rounded-2xl">
      ...
      <div>
        {data.map((data)=>(
            <h3 className="flex flex-col items-start gap-3 font-medium text-[1rem] text-(--text-main) py-[0.94rem]  border-t border-[#E5E5E5]">
          {data.title}

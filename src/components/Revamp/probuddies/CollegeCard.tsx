    ...
    return (
        ...
        >
            ...
            <div className="absolute flex flex-col w-full h-full z-10 p-3">
                <img src="/college.jpg" alt="college_image" className="w-full h-[167px] rounded-[8px] object-cover" />
                <h1 className="font-medium mt-2.5 text-[1rem] text-(--text-main)">Lorem ipsum dolor sit amet consectetur.</h1>
                <p className="text-(--text-muted) font-medium text-[0.875rem] mt-auto mb-[6px]">24 Courses | Hyderabad</p>
            </div>

...
//             >
//             See All
//             <img  src="/seeAll.svg" className="h-6 ml-2 group-hover:filter group-hover:invert" />
//             </Button>

//           <a className="flex gap-2 lg:hidden items-center cursor-pointer" onClick={() => navigate('/counselors')}>
//             See All
...
//             <div className="flex gap-[12px] sm:gap-[16px] lg:gap-[26px]">
//               {loading 
//               ? [...Array(6)].map((_, idx) => (
//               <div
//               key={idx}
//               className="flex-shrink-0 w-1/2 sm:w-1/2 lg:w-[380px]"
//             >

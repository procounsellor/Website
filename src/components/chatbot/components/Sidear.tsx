...
import { EllipsisVertical, Search, ArrowLeft, X, Lock, Loader2, Bookmark } from "lucide-react";
...
// FIX 1: Added 'cursor-pointer' here so Expand, New Chat, and Search icons are clickable
...
export default function Sidebar({
  ...
  const handleDelete = async (chatId: string) => {
    if (confirm("Are you sure you want to delete this chat?") && userId) {
    ...
    <>
      ...
      {isSidebarOpen ? (
        <div className="w-full h-full p-8 flex flex-col">
          <div className="grow overflow-y-auto scrollbar-hide">
            <div className="flex items-center justify-between mb-6">
              <button
                ...
                // FIX 2: Added cursor-pointer
                className="flex items-center gap-2 text-white font-semibold text-sm hover:bg-white/10 px-3 py-2 rounded-lg transition-colors cursor-pointer"
              >
              ...
              <button onClick={() => setIsSidebarOpen(false)} className="text-white hover:bg-white/10 p-2 rounded-lg transition-colors cursor-pointer">
                ...
                <div className="space-y-1">
                  ...
                  {chatSessions.map((chat) => (
                    <div key={chat.sessionId} className="relative">
                      {/* --- CONDITIONAL RENDERING: INLINE EDIT vs NORMAL BUTTON --- */}
                      {editingSessionId === chat.sessionId ? (
                        <div className="w-full rounded-lg py-1.5 px-3 bg-white/10 flex items-center gap-2">
                           <input
                             ref={editInputRef}
                             value={editTitle}
                             ...
                             className="bg-transparent text-white text-sm w-full outline-none border-b border-[#FF660F]"
                             autoFocus
                           />
                        </div>
                      ) : (
                        <div 
                          ...
                          // FIX 2: Added cursor-pointer (although it was present in your snippet, good to confirm)
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 overflow-hidden">
                              ...
                              {chat.isBookmarked && (
                                <Bookmark size={12} className="text-[#FF660F] shrink-0 fill-current" />
                              )}
          ...
          <div>
            {/* FIX 2: Added cursor-pointer to "Back to Home" */}

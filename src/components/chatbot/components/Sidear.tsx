...
// Used to keep styles consistent across different buttons
const Tooltip = ({ text, position = "right" }: { text: string, position?: "right" | "bottom" }) => {
  ...
  const positionClasses = position === "right" 
    ...
    : "top-full mt-2 left-1/2 -translate-x-1/2"; // bottom placement
...
// FIXED: Added 'group' and 'relative' to className so tooltips work
          ...
          <div className="grow overflow-y-auto scrollbar-hide">
            <div className="flex items-center justify-between mb-6">
              ...
              >
                ...
                {/* Added Text Back and Tooltip for Expanded View */}
                <span>New Chat</span>
              ...
              <div className="flex items-center justify-between px-2 mb-3">
                ...
                {isAuthenticated && (
                  <button 
                    ...
                    // Added Tooltip to Expanded Search

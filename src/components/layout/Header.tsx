...
import { User2, Search, X, LogOut, LayoutDashboard, Library, TvMinimalPlay } from "lucide-react";
                    ...
                    <div className="flex h-14 md:h-20 items-center justify-between px-5 lg:px-20">
                        ...
                        <div
                            ...
                            style={{
                                ...
                                transform: showHeaderSearch ? 'translateY(0)' : 'translateY(6px)',
                        ...
                        <div className="flex items-center gap-3 ml-auto">
                            <div className="hidden md:flex items-center" style={{ gap: "12px" }}>
                                ...
                                <NewHeaderButton
                                    label="My Courses"
                                    onClick={() => handleNewHeaderNavigation('/dashboard-student?activeTab=My Courses')}
                                />
                            </div>
                            <div className="btn flex items-center gap-3 shrink-0" 

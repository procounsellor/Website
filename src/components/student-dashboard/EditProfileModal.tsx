    ...
    >
      <div className="md:hidden h-full w-full bg-[#F5F5F7] flex flex-col">
        ...
        <div className="flex-grow overflow-y-auto p-8">
          <div className="relative w-[122px] h-[122px] mx-auto mb-8">
              <img
              ...
              />
              <button className="absolute bottom-1 right-1 w-5 h-5 bg-white rounded-md flex items-center justify-center border shadow-sm hover:bg-gray-100 p-0.5">
                  <SquarePen size={14} className="text-[#343C6A]" />
              </button>
          </div>

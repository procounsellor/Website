  ...
  return (
    <div className="flex flex-col gap-4 md:gap-6 w-full">
      ...
      <div className="bg-white rounded-2xl border border-[#EFEFEF] shadow-[0px_0px_4px_0px_#23232326] p-4 md:p-6">
        <h3 className="text-[#343C6A] font-semibold text-[18px] md:text-[20px] leading-[125%]" style={{ fontFamily: 'Montserrat' }}>
          About
        </h3>
      ...
      <div className="bg-white rounded-2xl border border-[#EFEFEF] shadow-[0px_0px_4px_0px_#23232326] py-4 md:py-6 px-3 md:px-4">
        <div className="flex justify-between items-start px-1 md:px-8">
          ...
          <div className="flex flex-col items-center gap-2 md:gap-3 w-1/3">
             <div className="h-[35px] md:h-[50px] flex items-center justify-center">
              <img src="/naac.svg" alt="NAAC" className="h-full object-contain" />
            </div>
            <span className="text-[#232323] font-medium text-[10px] md:text-[16px] text-center leading-tight" style={{ fontFamily: 'Poppins' }}>
              NAAC A++
            </span>
          ...
          <div className="flex flex-col items-center gap-2 md:gap-3 w-1/3">
             <div className="h-[35px] md:h-[50px] flex items-center justify-center">
              <img src="/aicte.svg" alt="AICTE" className="h-full object-contain" />
            </div>
            <span className="text-[#232323] font-medium text-[10px] md:text-[16px] text-center leading-tight" style={{ fontFamily: 'Poppins' }}>
              AICTE Approved
            </span>
      ...
      <div className="bg-white rounded-2xl border border-[#EFEFEF] shadow-[0px_0px_4px_0px_#23232326] p-4 md:p-6">
        ...
        <p className="text-[#718EBF] font-medium text-[14px] md:text-[16px] leading-[125%] mt-2 md:mt-3" style={{ fontFamily: 'Montserrat' }}>
          Hauz Khas, New Delhi, Delhi 110016
        </p>
      </div>

      <div className="bg-white rounded-2xl border border-[#EFEFEF] shadow-[0px_0px_4px_0px_#23232326] p-4 md:p-6">
        <h3 className="text-[#343C6A] font-semibold text-[18px] md:text-[20px] leading-[125%] mb-4 md:mb-6" style={{ fontFamily: 'Montserrat' }}>
          Contact
        </h3>
        ...
        <div className="space-y-4 md:space-y-6">
          <div className="flex items-start gap-3 md:gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-[#9D9FA1] font-medium text-[12px] md:text-[14px] leading-none mb-1" style={{ fontFamily: 'Montserrat' }}>
                Website
              </span>
              <a href="https://www.iitd.ac.in" target="_blank" rel="noreferrer" className="text-[#2F3032] font-medium text-[14px] md:text-[16px] leading-none hover:text-[#13097D]" style={{ fontFamily: 'Montserrat' }}>
                www.iitd.ac.in
              </a>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 md:gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[#2F3032] font-medium text-[14px] md:text-[16px] leading-none" style={{ fontFamily: 'Montserrat' }}>
                011-2659-7135
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 md:gap-4">
            ...
            <div className="flex flex-col">
              ...
              <a href="mailto:webmaster@admin.iitd.ac.in" className="text-[#2F3032] font-medium text-[14px] md:text-[16px] leading-none hover:text-[#13097D]" style={{ fontFamily: 'Montserrat' }}>

...
const CounsellorListing: React.FC = () => {
    ...
    const experienceLevels = [
        { label: "Entry Level", sub: "0-1 years", value: "<1" },
        { label: "Junior Level", sub: "1-3 years", value: ">1 and <=3" },
        { label: "Senior Level", sub: "3+ years", value: ">3" },
    ];
    ...
    const isPriceChanged = minPrice !== "" || maxPrice !== "";
    ...
    return (
        <div className="mt-8 ml-[60px] flex flex-row items-start gap-[16px]">
            {/* Left Sidebar */}
            <div className="flex flex-col flex-shrink-0 w-[312px]">
